...
function renderSaleCart() {
    ...
    tbody.innerHTML = saleCart.map(function (c, i) {
        ...
        if (discParts.length === 0) {
            discParts.push('<span onclick="event.stopPropagation();openItemDiscountSingle(\'' + c.id + '\')" style="cursor:pointer;color:var(--text-muted);font-size:12px;font-weight:500">\uD83C\uDFF7</span>');
        }
