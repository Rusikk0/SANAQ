import { closeModal, getCurrentStoreName, filterByPeriod, card, fmt, tableHTML, finCard, fmtDate, esc, switchAuditsTab, confirmAction, posRefreshFavorites, updateBulkBar } from './utils.js';
import { set } from './app-context.js';
import { isAdmin, checkPermission, hasGroupPermission, currentUser, posCashierName, renderCashiersPage, getOpenShiftForCashier, getUsers, getLocalUsers, setLocalUsers } from './users.js';
...
import { getSales, isSaleActive, groupSalesIntoReceipts, badgePay, renderSalesToday, renderSalesHeatmap, renderMostExpensiveReceipt, getWriteOffs, getAudits, getDeferred, updateSaleShiftBanner, addAuditLog, clearSaleSelection, focusSaleSearch, migrateDeferredData, renderDeferred, PAY_LABELS, migrateSalesRecords } from './sales.js';
...
import { currentStoreId, scanLastKey, scanBuffer, confirmCallback, _bulkSelected } from './store.js';
...
function openPosCategories() {
    try {
        ...
        toast('Ошибка загрузки категорий', 'err');
    }
}
