import { getProducts, setProducts, renderProducts, fillSaleProducts, smartMatchProducts, findProductByScan, setSelectedCartItemId, getProductDiscount } from './products.js';
...
import { saleCart, setSaleCart, renderSaleCart, addToCart } from './cart.js';
...
function doSaleSearch() {
    ...
    // If no search term, show products in the grid area
    if (!term.trim()) {
    ...
    // Search term present: show dropdown
...
function onSaleSearchKey(e) {
    ...
    if (e.key === 'Enter') {
        e.preventDefault();
        // If an item is highlighted via arrows, use that
