...
import { saleCart, setSaleCart, renderSaleCart, addToCart, setCartDiscountInfo, _cartDiscountInfo } from './cart.js';
...
function completeSale() {
    ...
    var _cartDisc = _cartDiscountInfo;
    ...
    let cartDiscAmt = 0;
    if (_cartDisc) {
        if (_cartDisc.type === 'percent') {
            cartDiscAmt = subTotal * _cartDisc.value / 100;
        } else {
            cartDiscAmt = Math.min(_cartDisc.value, subTotal);
        }
    }
