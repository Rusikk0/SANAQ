...
(function (global) {
  ...
  function buildInvoiceHTML(doc) {
    ...
    var logo = (window.DataService && window.DataService.getAppData && window.DataService.getAppData('store_logo')) || localStorage.getItem('ap_store_logo') || '';
    var bankName = (window.DataService && window.DataService.getAppData && window.DataService.getAppData('store_bank_name')) || localStorage.getItem('ap_store_bank_name') || 'АО "Банк ЦентрКредит"';
    ...
    var iik = (window.DataService && window.DataService.getAppData && window.DataService.getAppData('store_iik')) || localStorage.getItem('ap_store_iik') || 'KZ308562204126830393';
    var bik = (window.DataService && window.DataService.getAppData && window.DataService.getAppData('store_bik')) || localStorage.getItem('ap_store_bik') || 'KCJBKZKX';
    var paymentCode = (window.DataService && window.DataService.getAppData && window.DataService.getAppData('store_payment_code')) || localStorage.getItem('ap_store_payment_code') || '19';
